...
import AppointmentBookedService from './AppointmentBookedService'
...
export default class Appointment extends Model {
	...
	static fields () {
		...
		return {
			...
			appointment_booked_services: this.hasMany(AppointmentBookedService,'appointment_id')
		}
	}
}