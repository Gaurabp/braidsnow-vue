		...
		<div class="container">
			<div class="row">
				<div class="col-md-7 col-sm-12 col-12 mx-auto">
					<div class="section-header text-center">
						<img width="59" height="44" alt="Logo" src="assets/img/icon.png">
							<h2 class="header-title" style="font-family:Arial,sans-serif !important;">{{ setting.sec3_title }}</h2>
...
<h4 class="title">
	<c v-for="(service,index) in braider.user_services" :key="service.id">{{service.service}}{{ (braider.user_services.length-1) == index?'':', '}} </c>
</h4>
<div class="rating">
...
<div class="row">
<div class="col-md-12">
<h3>Why Join BraidsNow.com</h3>
	
		<p style="font-size: 18px;" v-for="(why,index) in why" :key="why.id">
		{{ ++index }}. {{why.content}}</p>
